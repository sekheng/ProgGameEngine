...
bool GameScene::init()
{
	...
	m_ButtonListener = MKInputManager::GetInstance()->CreateEventListener<MKInputButton>(CC_CALLBACK_1(GameScene::OnButtonInput, this));
...
void GameScene::OnButtonInput(EventCustom* _event)
{
