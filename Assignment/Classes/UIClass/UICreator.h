...
public:
	//Create Button
	ui::Button* createButton(const Vec2& _position, const std::string& _normalSprite, const std::string& _pressedSprite, const std::function<void(Ref*, ui::Widget::TouchEventType)>& _funcPtr)
	{
